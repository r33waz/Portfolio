...
function About() {
  return (
    <div className="grid md:grid-cols-2 grid-cols-1 place-items-center place-content-center md:mt-0 mt-60 bg-[url(../assets/images/wave-haikei.png)] bg-no-repeat bg-cover bg-center w-full min-h-[90vh]">
      <div className="grid md:grid-cols-2 grid-cols-1 gap-2 ">
        <Fade cascade>
          <Image
            ...
            width={0}
            height={0}
            className="rounded-lg h-[60vh] md:w-full w-fit hover:scale-105 duration-500"
          />
          <Image
            src={About_img_2}
            alt="Riwaz Thapa"
