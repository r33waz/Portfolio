    ...
    (<Link
      ...
      <span
        ...
        <span
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl   dark:bg-black border bg-white border-white/[0.1] group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden dark:shadow-[0px_1px_2px_1px_#f7fafc] shadow-[0px_1px_2px_1px_#cbd5e0]">
...
export const PinPerspective = ({
  ...
  return (
    (<motion.div
      className="pointer-events-none  w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500 mt-4 ">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-full dark:text-white dark:bg-zinc-950 bg-white text-black dark:border-black border-white py-0.5 px-4 ring-1 border">
            <span
              className="relative z-20 dark:text-white  text-black  text-xs font-bold inline-block py-0.5">
              {title}
            </span>
